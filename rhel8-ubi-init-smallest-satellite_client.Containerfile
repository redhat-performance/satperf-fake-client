...
RUN echo -e "[satellite_client]\nname=satellite_client\nbaseurl=http://satellite.sat.engineering.redhat.com/pulp/content/Satellite_Engineering/QA/Satellite_Client_2/custom/Satellite_Client_2_Composes/Satellite_Client_2_RHEL8_x86_64/\ngpgcheck=0\nenabled=1" >/etc/yum.repos.d/satellite_client.repo && \
